...
/**
 * Generate the API URL for the WeatherKit API using coordinates.
 * @param {number} lat - Latitude
 * @param {number} lng - Longitude  
 * @param {string} forecast - Dataset type
 * @returns {string} url
 */
function generateLocationApiUrl(lat, lng, forecast = "currentWeather") {
...
async function getLocationWeather(lat, lng, forecast = "currentWeather") {
  ...
  const url = generateLocationApiUrl(lat, lng, forecast);
